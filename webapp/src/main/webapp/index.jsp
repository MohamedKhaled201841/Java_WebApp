        ...
        <div class="container">
            ...
            <div class=" m-5">
                <ul class="list-group mt ">
                    ...
                    <li class="list-group-item"><a href="webapi/myresource/mostPopularSkill">Most important skills</a></li>
                </ul>
                <div class="card m-5" >
                    ...
                    <ul class="list-group mt ">
                        <li class="list-group-item"><p>Omar Safwat</p><p>Mohamed Khaled</p><p>Mostafa Mohamed Fathy</p></li>
                    </ul>
                </div>
            </div>
